...
generated by yoshitha dilmith😈
😌මම නං කොහොමත් අහින්සකයි රටක් වටී😁❤️
🥺පාලුයි අනේ. අපි සෙල්ලමක් කරමුද?😊✌️
😝මම නං මුකුත් කරන්නෑ අනේ😁 ඔයාලා දිහා බලන් ඉන්නවා😌
😇දැම්ම නිදාගන්න බෑ අනේ😜 නිදිමත නෑ😁💞
owner= yoshitha dilmith` //Costomize Alive Message (type your message in `` )
...
global.ownername = "😎yoshitha dilmith❯❯" // owner name
global.ytname = "" // yt chanel name
global.socialm = "GitHub: prabhasha2006" // github or insta name
global.location = "India, Mizoram, Aizawl" // location

//bot body 
global.alivepic = `https://ibb.co/L9ZjSjQ.png` // alive picture \\ use "https://ibb.com" to upload photos. < 1 MB
...
global.botname = 'jupiter bot' //ur bot name
global.packname = "Bot Sticker" // sticker packname
global.author = "𝙍𝙀𝘿╺ 𝘿𝙍𝘼𝙂𝙊𝙉" // sticker author
global.dragonemoji = '💖...' // Menu emoji
global.footer = '[ ◉ yoshitha MD ]' //
